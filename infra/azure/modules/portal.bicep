...
@description('Tech Playground management resource group created by the foundation deployment.')
param managementResourceGroupName string

@description('Dedicated Tech Playground Log Analytics workspace in the management resource group.')
...
resource portal 'Microsoft.App/containerApps@2026-01-01' = {
  name: 'ca-${namePrefix}-portal-${regionCode}'
  location: location
  tags: tags
  identity: {
    type: 'UserAssigned'
